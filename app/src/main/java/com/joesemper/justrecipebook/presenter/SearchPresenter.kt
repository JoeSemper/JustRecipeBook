...
import com.joesemper.justrecipebook.ui.fragments.search.adapter.MealItemView
...
class SearchPresenter(val searchType: SearchType?, val query: String?) : MvpPresenter<SearchFragmentView>() {
