...
class SearchFragmentFragment : MvpAppCompatFragment(), SearchFragmentView, BackButtonListener {
    ...
    val presenter: SearchPresenter by moxyPresenter {
        ...
        SearchPresenter(searchType, query).apply {
...
//        searchView.setSearchableInfo(searchManager.getSearchableInfo(requireActivity().componentName))
    ...
    private class QueryListener(val presenter: SearchPresenter, val searchView: SearchView) :
