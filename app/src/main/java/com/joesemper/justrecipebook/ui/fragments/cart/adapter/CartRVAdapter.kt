...
class CartRVAdapter(val presenter: ICartListPresenter) :
    ...
    inner class ViewHolder(override val containerView: View) :
        RecyclerView.ViewHolder(containerView), LayoutContainer, CartItemView {

        override var pos = -1

        var checkBoxClickListener: View.OnClickListener? = null
            set(value) {
                containerView.checkBox_cart_ingredient.setOnClickListener(value)
            }
        ...
        override fun setIngredientIsBought() = with(containerView) {
            ...
            card_cart_ingredient.foreground =
                ContextCompat.getDrawable(context, R.color.foreground_tint_cart)
        }
    ...
    override fun onBindViewHolder(holder: CartRVAdapter.ViewHolder, position: Int) {
        ...
        holder.checkBoxClickListener = View.OnClickListener { presenter.checkBoxClickListener?.invoke(holder) }
